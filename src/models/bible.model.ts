...
// TypeScript interface for a Bible Book
...
// TypeScript interface for a Bible Chapter
export interface IBibleChapter extends Document {
...
// TypeScript interface for a Bible Verse
...
// TypeScript interface for Bible Search Result
export interface IBibleSearchResult {
  verse: IBibleVerse;
  book: IBibleBook;
  chapter: IBibleChapter;
...
const bibleChapterSchema = new Schema<IBibleChapter>(
  {
    bookId: {
...
export const BibleBook =
  mongoose.models.BibleBook ||
  mongoose.model<IBibleBook>("BibleBook", bibleBookSchema);

export const BibleChapter =
  mongoose.models.BibleChapter ||
  mongoose.model<IBibleChapter>("BibleChapter", bibleChapterSchema);

export const BibleVerse =
  mongoose.models.BibleVerse ||
  mongoose.model<IBibleVerse>("BibleVerse", bibleVerseSchema);
