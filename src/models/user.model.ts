...
export interface IUser {
  ...
  settings?: {
    profileLock?: boolean;
    liveSettings?: boolean; // Placeholder for future live streaming settings
    pushNotifications?: boolean; // Simplified boolean for push notifications
...
const userSchema = new Schema<IUserDocument>(
  {
    ...
    settings: {
      ...
      liveSettings: { type: Boolean, default: false }, // Placeholder for future
      pushNotifications: { type: Boolean, default: true }, // Simplified boolean
      recommendationSettings: { type: Boolean, default: true },
    },
