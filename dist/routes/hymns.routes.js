...
// Rate limiters
const searchRateLimiter = (0, rateLimiter_1.rateLimiter)(20, 60000); // 20 requests per minute
const syncRateLimiter = (0, rateLimiter_1.rateLimiter)(5, 60000); // 5 requests per minute
 ...
 *         description: Internal server error
 */
router.post("/sync/popular", auth_middleware_1.verifyToken, syncRateLimiter, hymns_controller_1.syncPopularHymns);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.patch("/:id/interactions", auth_middleware_1.verifyToken, interactionRateLimiter, hymns_controller_1.updateHymnInteractions);
