 ...
 *         description: Internal server error
 */
router.post("/library/add", auth_middleware_1.verifyToken, rateLimiter_1.apiRateLimiter, enhancedMedia_controller_1.addToLibrary);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.delete("/library/:mediaId/:mediaType", auth_middleware_1.verifyToken, rateLimiter_1.apiRateLimiter, enhancedMedia_controller_1.removeFromLibrary);
/**
 * @swagger
 * /api/media/library:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/library", auth_middleware_1.verifyToken, rateLimiter_1.apiRateLimiter, enhancedMedia_controller_1.getUserLibrary);
/**
 * @swagger
 * /api/media/progress:
 *   put:
 ...
 *         description: Internal server error
 */
router.put("/progress", auth_middleware_1.verifyToken, rateLimiter_1.apiRateLimiter, enhancedMedia_controller_1.updateWatchProgress);
/**
 * @swagger
