"use strict";
// NOTE: Nodemailer transport is disabled in Resend-only mode
...
exports.EmailService = exports.emailTemplates = exports.emailConfig = void 0;
// Email configuration retained for reference, but not used
exports.emailConfig = {
    ...
    static sendEmail(to, template) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Disabled: use Resend service instead of Nodemailer
                throw new Error("SMTP email sending disabled. Use Resend service instead.");
            }
            catch (error) {
