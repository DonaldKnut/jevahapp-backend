    ...
    try {
        ...
        const processedEmbeddedLinks = Array.isArray(embeddedLinks)
            ? embeddedLinks.map((link) => {
                ...
                return ({
                    url: link.url.trim(),
                    title: ((_a = link.title) === null || _a === void 0 ? void 0 : _a.trim()) || undefined,
                    description: ((_b = link.description) === null || _b === void 0 ? void 0 : _b.trim()) || undefined,
                    thumbnail: ((_c = link.thumbnail) === null || _c === void 0 ? void 0 : _c.trim()) || undefined,
                    type: link.type,
                });
            })
            : undefined;
        ...
        const existingPostsCount = yield forumPost_model_1.ForumPost.countDocuments({
            forumId: forum._id,
            userId: req.userId,
        });
        ...
        logger_1.default.info("Forum post created", {
            postId: post._id,
            forumId: forum._id,
            userId: req.userId,
            contentLength: trimmedContent.length,
            embeddedLinksCount: (processedEmbeddedLinks === null || processedEmbeddedLinks === void 0 ? void 0 : processedEmbeddedLinks.length) || 0,
            tagsCount: (processedTags === null || processedTags === void 0 ? void 0 : processedTags.length) || 0,
        });
        res.status(201).json({
            success: true,
        ...
        logger_1.default.error("Error creating forum post", {
            error: error.message,
