...
const reportContentComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield contentInteraction_service_1.default.reportContentComment(commentId, userId, reportReason);
        ...
        try {
            ...
            if (adminEmails.length > 0) {
                ...
                logger_1.default.info("Admin notifications sent for comment report", {
                    commentId,
                    mediaId: result.media.id,
            ...
            logger_1.default.error("Failed to send admin notifications for comment report:", emailError);
        ...
        if (result.reportCount >= 3) {
            try {
                ...
                logger_1.default.error("Failed to send threshold alert for comment:", thresholdEmailError);
            }
        }
        logger_1.default.info("Comment reported", {
            commentId,
            userId,
            reason: reportReason,
            reportCount: result.reportCount,
