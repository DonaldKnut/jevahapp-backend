...
exports.validatePrayerData = validatePrayerData;
exports.validatePrayerUpdateData = validatePrayerUpdateData;
...
function validatePrayerData(data) {
    ...
    if (data.verse !== undefined && data.verse !== null) {
        if (typeof data.verse !== "object" || Array.isArray(data.verse)) {
            ...
            const verseText = ((_a = data.verse.text) === null || _a === void 0 ? void 0 : _a.trim()) || null;
            const verseReference = ((_b = data.verse.reference) === null || _b === void 0 ? void 0 : _b.trim()) || null;
 ...
 */
function validatePrayerUpdateData(data) {
    var _a, _b;
    const errors = [];
    const details = {};
