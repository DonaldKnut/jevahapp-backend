...
async function resetDefaultContent() {
  try {
    ...
    console.log("🧹 STEP 1: Cleaning up old placeholder content...");
    ...
    console.log("\n🌱 STEP 2: Seeding new enhanced content...");
    ...
    console.log(`✅ Successfully seeded ${result.length} enhanced content items`);
    ...
    console.log("🇳🇬 Nigerian creator profiles properly attributed");

  } catch (error) {
    console.error("❌ Error resetting default content:", error);
  } finally {
