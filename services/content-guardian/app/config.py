...
VIOLENCE_REJECT = _env_float("GUARDIAN_VIOLENCE_REJECT", 0.45)
GORE_REJECT = _env_float("GUARDIAN_GORE_REJECT", 0.40)
WEAPONS_REJECT = _env_float("GUARDIAN_WEAPONS_REJECT", 0.48)
DRUGS_REJECT = _env_float("GUARDIAN_DRUGS_REJECT", 0.48)
SEXUAL_SCENE_REJECT = _env_float("GUARDIAN_SEXUAL_SCENE_REJECT", 0.50)
